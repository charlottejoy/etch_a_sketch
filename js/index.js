...
function drawing(direction) {
  ...
  if (direction == "downRight") {
    if (
      selectedCellNumber + totalCells <= totalRows * totalCells &&
      selectedCellNumber % totalCells != 0
    ) {
  ...
  if (direction == "upLeft") {
    if (
      selectedCellNumber % totalCells != 1 &&
      selectedCellNumber - totalCells > 0
    ) {
      selectedCellNumber = selectedCellNumber - totalCells - 1;
    }
